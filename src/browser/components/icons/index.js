...
const glyphMap = {
  ...
  // 'ios-refresh-circle-outline': require('./io/ios-refresh-circle-outline')
  //   .default,
  ...
  // 'go-home': require('./go/home').default,
  // 'go-menu': require('./go/three-bars').default,

  // home: require('./fa/home').default,
  'md-home': require('./md/home').default,
  // menu: require('./fa/bars').default,
  'md-menu': require('./md/menu').default,
